...
package Library.Network is
   ...
   type Network_Type is tagged private;

   type Network_Access_Type is access Network_Type'Class;

   procedure Initialize
     (This : in out Network_Type; Device_Identifier : Device_Identifier_Type;
   ...
   function Get_Device_Identifier
     (This : in out Network_Type) return Device_Identifier_Type;

private

   type Network_Type is tagged record
