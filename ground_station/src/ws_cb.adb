      ...
      for Aircraft_Index in Types.State.Aircraft_Index_Type loop
         ...
         declare
            ...
            Velocity_Obj : GNATCOLL.JSON.JSON_Value :=
              GNATCOLL.JSON.Create_Object;
            Acceleration_Obj : GNATCOLL.JSON.JSON_Value :=
              GNATCOLL.JSON.Create_Object;
         ...
         begin
            ...
            Acceleration_Obj.Set_Field
              ("x", Float (Aircraft.Acceleration_Vector (Types.Physics.X)));
            Acceleration_Obj.Set_Field
              ("y", Float (Aircraft.Acceleration_Vector (Types.Physics.Y)));
            Acceleration_Obj.Set_Field
              ("z", Float (Aircraft.Acceleration_Vector (Types.Physics.Z)));
            ...
            Aircraft_Obj.Set_Field ("acceleration", Acceleration_Obj);
